...
final List<Destination> destinations = [
  Destination(
    ...
    subCategoryId: getSubCategories([1, 3, 5]),
    dos: [
    ...
    facilities: getFacilities([1, 2, 3, 4, 5 ,6]),
    sos: getSOS([1]),
  ),
  Destination(
    id_destination: 2,
    ...
    subCategoryId: getSubCategories([2]),
    dos: [
  ...
  Destination(
    ...
    subCategoryId: getSubCategories([3, 2]),
    dos: [
  ...
  Destination(
    ...
    subCategoryId: getSubCategories([4]),
    dos: [
  ...
  Destination(
    ...
    subCategoryId: getSubCategories([5, 1]),
    dos: [
